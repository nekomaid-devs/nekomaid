...
export default {
    ...
    async execute(command_data: CommandData) {
        if (command_data.message.guild === null || command_data.message.guild.me === null || !(command_data.message.channel instanceof TextChannel) || command_data.guild_data.counters === null) {
            return;
        }
        /*
