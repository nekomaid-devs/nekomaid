...
export default {
    ...
    execute(command_data: CommandData) {
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_city_hall, "b_city_hall"))} $)\`\n`;
        buildings_description += `\`[Neko's Bank]          [${"=".repeat(command_data.tagged_user_config.b_bank)}>${" ".repeat(10 - command_data.tagged_user_config.b_bank)}] Level ${command_data.tagged_user_config.b_bank} (${format_number(
            get_building_price(command_data.tagged_user_config.b_bank, "b_bank")
        )} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_lab, "b_lab"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_sanctuary, "b_sanctuary"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_pancakes, "b_pancakes"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_crime_den, "b_crime_den"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_lewd_services, "b_lewd_services"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_casino, "b_casino"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_scrapyard, "b_scrapyard"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.tagged_user_config.b_pawn_shop, "b_pawn_shop"))} $)\``;
