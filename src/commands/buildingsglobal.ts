...
export default {
    ...
    async execute(command_data: CommandData) {
        ...
        } (${format_number(get_building_price(command_data.global_context.bot_config.b_mayor_house, "b_mayor_house"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.global_context.bot_config.b_shrine, "b_shrine"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.global_context.bot_config.b_community_center, "b_community_center"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.global_context.bot_config.b_quantum_pancakes, "b_quantum_pancakes"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.global_context.bot_config.b_crime_monopoly, "b_crime_monopoly"))} $)\`\n`;
        ...
        } (${format_number(get_building_price(command_data.global_context.bot_config.b_pet_shelter, "b_pet_shelter"))} $)\``;
