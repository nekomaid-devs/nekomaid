...
export default {
    ...
    execute(command_data: CommandData) {
        ...
        credits_amount *= command_data.global_context.bot_config.work_multiplier;
        credits_amount *= command_data.global_context.bot_config.shrine_bonus === ShrineBonus.WORK ? [ 1, 1.01, 1.01, 1.03, 1.05, 1.07, 1.1, 1.1, 1.15, 1.15, 1.15 ][command_data.global_context.bot_config.b_shrine] : 1;
