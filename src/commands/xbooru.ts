...
export default {
    ...
    async execute(command_data: CommandData) {
        ...
        const post_info = await command_data.global_context.neko_modules_clients.xbooru.xbooru_result(command_data.global_context, command_data.args);
        ...
        command_data.msg.channel.send({ embeds: [ embedXbooru ] }).catch((e: Error) => {
