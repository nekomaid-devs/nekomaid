...
import { get_cuddle_gifs } from "../scripts/utils/vars";
...
export default {
    ...
    execute(command_data: CommandData) {
        ...
        const url = pick_random(get_cuddle_gifs());
        const embedKiss = {
            title: `${command_data.message.author.tag} cuddles ${format_users(command_data.tagged_users)}!`,
            color: 8388736,
            image: {
                url: url,
            },
