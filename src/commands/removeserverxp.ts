...
export default {
    ...
    arguments: [new Argument(1, "You need to mention an user.", "mention", true), new Argument(1, "You need to type in an amount.", "float>0", true)],
    ...
    execute(command_data: CommandData) {
        ...
        command_data.message.channel.send(`Removed \`${add_XP}\` XP from \`${command_data.tagged_user.tag}\`! (Current XP: \`${Math.round(command_data.tagged_user_guild_data.xp)}\`)`).catch((e: Error) => {
