class E621API {
    async e621_result(global_context, args) {
        ...
        let result_pages = await global_context.modules.axios.get(site_url_pages, { headers: { Cookie: "gw=seen;", "User-Agent": "Nekomaid/2.0" } }).catch((e) => {
        ...
        let result_main = await global_context.modules.axios.get(site_url_main, { headers: { Cookie: "gw=seen;", "User-Agent": "Nekomaid/2.0" } }).catch((e) => {
            global_context.logger.neko_api_error(e);
        });
        ...
        let result_post = await global_context.modules.axios.get(site_url_post, { headers: { Cookie: "gw=seen;", "User-Agent": "Nekomaid/2.0" } }).catch((e) => {
            global_context.logger.neko_api_error(e);
        });
