    ...
    async import_into_context(global_context) {
        ...
        if (global_context.config.sentry_enabled === true) {
            global_context.modules.Sentry.init({
                ...
                integrations: [new global_context.modules.Sentry.Integrations.Http({ tracing: true })],
        ...
        global_context.utils.verify_guild_channels = async (guild) => {
            let channels = await guild.channels.fetch().catch((e) => {
                global_context.logger.api_error(e);
            });
            channels.forEach((channel) => {
                guild.channels.cache.forceSet(channel.id, channel);
            });
        };
        global_context.utils.verify_guild_roles = async (guild) => {
            ...
            roles.forEach((role) => {
                guild.roles.cache.forceSet(role.id, role);
            });
        };
        global_context.utils.verify_guild_members = async (guild) => {
            let members = await guild.members.fetch().catch((e) => {
                global_context.logger.api_error(e);
            });
            members.forEach((member) => {
                guild.members.cache.forceSet(member.id, member);
            });
        };
        ...
        global_context.neko_modules.ServerStructureManager = require("./src/scripts/data/server_structure_manager");
        global_context.neko_modules_clients.ssm = new global_context.neko_modules.ServerStructureManager(sql_connection);

        global_context.neko_modules.Rule34API = require("./src/scripts/apis/rule34_api");
        global_context.neko_modules_clients.r34 = new global_context.neko_modules.Rule34API();

        global_context.neko_modules.GelbooruAPI = require("./src/scripts/apis/gelbooru_api");
        global_context.neko_modules_clients.gelbooru = new global_context.neko_modules.GelbooruAPI();

        global_context.neko_modules.XBooruAPI = require("./src/scripts/apis/xbooru_api");
        global_context.neko_modules_clients.xbooru = new global_context.neko_modules.XBooruAPI();

        global_context.neko_modules.RealbooruAPI = require("./src/scripts/apis/realbooru_api");
        global_context.neko_modules_clients.realbooru = new global_context.neko_modules.RealbooruAPI();

        global_context.neko_modules.NHentaiAPI = require("./src/scripts/apis/nhentai_api");
        global_context.neko_modules_clients.nhentai = new global_context.neko_modules.NHentaiAPI();

        global_context.neko_modules.SafebooruAPI = require("./src/scripts/apis/safebooru_api");
        global_context.neko_modules_clients.safebooru = new global_context.neko_modules.SafebooruAPI();

        global_context.neko_modules.DanbooruAPI = require("./src/scripts/apis/danbooru_api");
        global_context.neko_modules_clients.danbooru = new global_context.neko_modules.DanbooruAPI();

        global_context.neko_modules.E621API = require("./src/scripts/apis/e621_api");
        global_context.neko_modules_clients.e621 = new global_context.neko_modules.E621API();

        global_context.neko_modules.TimeConvert = require("./src/scripts/utils/util_timeconvert");
        global_context.neko_modules_clients.tc = new global_context.neko_modules.TimeConvert();

        global_context.neko_modules.SortBy = require("./src/scripts/utils/util_sortby");
        global_context.neko_modules_clients.sb = new global_context.neko_modules.SortBy();

        global_context.neko_modules.LevelingManager = require("./src/scripts/modules/module_level_manager");
        global_context.neko_modules_clients.lvl = new global_context.neko_modules.LevelingManager();

        global_context.neko_modules.ModerationManager = require("./src/scripts/modules/module_moderation_manager");
        global_context.neko_modules_clients.moderator = new global_context.neko_modules.ModerationManager();

        global_context.neko_modules.MarriageProposal = require("./src/scripts/helpers/marriage_proposal");
        global_context.neko_modules.VoiceData = require("./src/scripts/helpers/voice_data");
        global_context.neko_modules.VoiceRequest = require("./src/scripts/helpers/voice_request");

        global_context.neko_modules.MarriageManager = require("./src/scripts/managers/marriage_manager");
        global_context.neko_modules_clients.mm = new global_context.neko_modules.MarriageManager();

        global_context.neko_modules.VoiceManager = require("./src/scripts/managers/voice_manager");
        global_context.neko_modules_clients.vm = new global_context.neko_modules.VoiceManager();

        global_context.neko_modules.UpvoteManager = require("./src/scripts/managers/upvote_manager");
        global_context.neko_modules_clients.um = new global_context.neko_modules.UpvoteManager();

        global_context.neko_modules.SupportServerManager = require("./src/scripts/managers/supportserver_manager");
        global_context.neko_modules_clients.supm = new global_context.neko_modules.SupportServerManager();

        global_context.neko_modules.CounterManager = require("./src/scripts/managers/counter_manager");
        global_context.neko_modules_clients.cm = new global_context.neko_modules.CounterManager();

        global_context.neko_modules.ReactionRolesManager = require("./src/scripts/managers/rr_manager");
        global_context.neko_modules_clients.rrm = new global_context.neko_modules.ReactionRolesManager();

        global_context.neko_modules.InventoryManager = require("./src/scripts/managers/inventory_manager");
        global_context.neko_modules_clients.im = new global_context.neko_modules.InventoryManager();

        global_context.neko_modules.EventManager = require("./src/scripts/managers/event_manager");
        global_context.neko_modules_clients.em = new global_context.neko_modules.EventManager();

        global_context.neko_modules.BuildingManager = require("./src/scripts/managers/building_manager");
        ...
        global_context.neko_modules.web_updates = require("./src/scripts/web_updates/web_updates");
        global_context.neko_modules.vars = require("./src/scripts/utils/util_vars");
