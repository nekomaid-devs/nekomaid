...
module.exports = {
    ...
    argumentsNeeded: [new NeededArgument(1, "You need to type in an username (ex. `LamkasDev` or `LamkasDev#4235`).")],
        ...
        command_data.msg.guild.bans
            ...
            .then((server_bans_result) => {
                ...
                if (usernames.length > 1) {
                    ...
                    command_data.msg.channel.send(`Unbanned \`${ban_info.user.tag}\`.`).catch((e) => {
                        command_data.global_context.logger.api_error(e);
                    });
                }
            })
