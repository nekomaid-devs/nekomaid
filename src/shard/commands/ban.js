...
module.exports = {
    ...
    execute(command_data) {
        ...
        let previous_ban = command_data.server_bans.find((e) => {
        ...
        if (previous_ban === undefined) {
            ...
            command_data.msg.channel.send(`Banned \`${command_data.tagged_user.tag}\` for \`${extended_time_text}\`. (Time: \`${ban_end_text}\`)`).catch((e) => {
