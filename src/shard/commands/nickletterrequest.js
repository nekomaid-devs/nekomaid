...
module.exports = {
    ...
    async execute(command_data) {
        ...
        let collector = message.createReactionCollector({ filter: filter });
        collector.on("collect", async (r, u) => {
            ...
            let reacted = await command_data.msg.guild.members.fetch(u.id).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
            ...
            await command_data.msg.member.setNickname(new_author_username).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
            await reacted.setNickname(new_reacted_username).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
        });
    },
