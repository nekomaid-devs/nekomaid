module.exports = {
    ...
    execute(command_data) {
        ...
        if (voice_data.mode === 0) {
            ...
            command_data.msg.channel.send(`Shuffled \`${voice_data.queue.length}\` songs.`).catch((e) => {
            ...
            command_data.msg.channel.send(`Shuffled \`${voice_data.persistent_queue.length}\` songs.`).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
        }
    },
