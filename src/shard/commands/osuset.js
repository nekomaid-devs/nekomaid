...
module.exports = {
    ...
    async execute(command_data) {
        ...
        let user = await command_data.global_context.modules_clients.osu.getUser({ u: command_data.total_argument }).catch((e) => {
            command_data.global_context.logger.api_error(e);
        });
        ...
        command_data.msg.channel.send(`Set osu! username to \`${command_data.total_argument}\`.`).catch((e) => {
            command_data.global_context.logger.api_error(e);
        });
    },
};
