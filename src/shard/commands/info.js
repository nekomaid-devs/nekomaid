module.exports = {
    ...
    async execute(command_data) {
        ...
        let allShards_memory_usage = await command_data.global_context.bot.shard
            .broadcastEval(() => {
        ...
        let manager_guilds = await command_data.global_context.bot.shard
            .fetchClientValues("guilds.cache.size")
            .then((results) => results.reduce((prev, guildCount) => prev + guildCount, 0))
            .catch((e) => {
                command_data.global_context.logger.error(e);
            });
        ...
        let manager_members = await command_data.global_context.bot.shard
        ...
        command_data.msg.channel.send({ embeds: [embedInfo] }).catch((e) => {
