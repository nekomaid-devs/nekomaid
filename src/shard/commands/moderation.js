...
module.exports = {
    ...
    execute(command_data) {
        ...
        switch (action) {
            case "add": {
                ...
                switch (property) {
                    case "banned_word": {
                        ...
                        command_data.msg.channel.send(`Added \`${value}\` to banned words.`).catch((e) => {
                            command_data.global_context.logger.api_error(e);
                        });
                        break;
                    }
            ...
            case "remove": {
                ...
                switch (property) {
                    case "banned_word": {
                        ...
                        command_data.msg.channel.send(`Removed \`${value}\` from banned words.`).catch((e) => {
                            command_data.global_context.logger.api_error(e);
                        });
                        break;
                    }
            ...
            case "set": {
                ...
                switch (property) {
                    case "invites": {
                        ...
                        command_data.msg.channel.send(`${bool ? "Allowed" : "Banned"} invites in messages.`).catch((e) => {
                            command_data.global_context.logger.api_error(e);
                        });
                        break;
                    }
            ...
            default: {
                command_data.msg.channel
                    .send({ embeds: [command_data.global_context.neko_modules.vars.get_error_embed(command_data.msg, command_data.server_config.prefix, this, "Invalid action- (Actions: `add`, `set`, `remove`)", "set invites true")] })
                    .catch((e) => {
                        command_data.global_context.logger.api_error(e);
                    });
                break;
