...
module.exports = {
    ...
    async execute(command_data) {
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_city_hall, "b_city_hall"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_bank, "b_bank"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_lab, "b_lab"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_sanctuary, "b_sanctuary"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_pancakes, "b_pancakes"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_crime_den, "b_crime_den"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_lewd_services, "b_lewd_services"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_casino, "b_casino"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_scrapyard, "b_scrapyard"))} $)\`\n`;
        ...
        } (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.tagged_user_config.b_pawn_shop, "b_pawn_shop"))} $)\``;
        ...
        command_data.msg.channel.send({ embeds: [embedBuildings] }).catch((e) => {
