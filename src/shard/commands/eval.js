...
module.exports = {
    ...
    async execute(command_data) {
        ...
        let embedFiles = [];
        let message = await command_data.msg.channel.send({ embeds: [embedEval] }).catch((e) => {
        ...
        try {
            ...
            message.edit({ embeds: [embedEval], files: embedFiles }).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
        } catch (err) {
            embedEval.description = err;
            message.edit({ embeds: [embedEval] }).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
        }
    },
