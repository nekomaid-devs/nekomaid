module.exports = {
    ...
    execute(command_data) {
        ...
        command_data.msg.channel.send(`Skipped \`${voice_request.info.title}\`. (\`${command_data.global_context.neko_modules_clients.vm.connections.get(command_data.msg.guild.id).queue.length}\` remaining)`).catch((e) => {
        ...
        command_data.global_context.neko_modules_clients.vm.play_next_on_connection(command_data.global_context, command_data.msg.guild.id);
    },
};
