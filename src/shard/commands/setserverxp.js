...
module.exports = {
    ...
    execute(command_data) {
        ...
        command_data.global_context.neko_modules_clients.lvl.update_server_level(command_data, set_XP);

        command_data.msg.channel.send(`Set \`${set_XP}\` XP to \`${command_data.tagged_user.tag}\`! (Current XP: \`${Math.round(command_data.taggedServerUserConfig.xp)}\`)`).catch((e) => {
