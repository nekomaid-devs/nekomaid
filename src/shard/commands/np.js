module.exports = {
    ...
    async execute(command_data) {
        ...
        let user = await command_data.global_context.bot.users.fetch(voice_data.current.request_user_ID).catch((e) => {
        ...
        if (user !== undefined) {
            ...
            command_data.msg.channel.send({ embeds: [embedNP] }).catch((e) => {
                command_data.global_context.logger.api_error(e);
            });
        }
    },
