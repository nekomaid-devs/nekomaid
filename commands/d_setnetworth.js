...
module.exports = {
    ...
    async execute(command_data) {
        ...
        command_data.msg.channel.send(`Set net worth to \`${command_data.global_context.utils.format_number(credits_ammount)}\` for \`${command_data.tagged_user.tag}\`!`).catch(e => { command_data.global_context.logger.api_error(e); });
    },
};