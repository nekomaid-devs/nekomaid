            ...
            switch(message.content) {
                case "stop":
                    if(roles.size < 1) {
                        ...
                        msg.edit("Cancelled the reaction menu.").catch(e => { command_data.global_context.logger.api_error(e); });
                        return;
                    }
                    ...
                    Array.from(roles.keys()).forEach(role_ID => {
                        ...
                        msg.react(emoji).catch(e => { command_data.global_context.logger.api_error(e); });
