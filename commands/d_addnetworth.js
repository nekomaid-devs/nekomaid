...
module.exports = {
    ...
    execute(command_data) {
        ...
        command_data.msg.channel.send(`Added \`${credits_ammount}\` net worth to \`${command_data.tagged_user.tag}\`! (Current net worth: \`${command_data.tagged_user_config.netWorth}$\`)`).catch(e => { command_data.global_context.logger.api_error(e); });
    },
};