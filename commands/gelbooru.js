...
module.exports = {
    ...
    async execute(command_data) {
        let post_info = await command_data.global_context.neko_modules_clients.gelbooru.gelbooru_result(command_data.global_context, command_data.args);
        ...
        command_data.msg.channel.send("", { embed: embedGelbooru }).catch(e => { command_data.global_context.logger.api_error(e); });
    },
};