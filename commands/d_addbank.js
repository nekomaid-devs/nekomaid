...
module.exports = {
    ...
    execute(command_data) {
        ...
        command_data.msg.channel.send(`Added \`${credits_ammount}\` bank to \`${command_data.tagged_user.tag}\`! (Current bank: \`${command_data.tagged_user_config.bank}$\`)`).catch(e => { console.log(e); });
    },
};