module.exports = {
    ...
    async execute(command_data) {
        ...
        let recent = await command_data.global_context.modules_clients.osu.getUserRecent({ u: command_data.tagged_user_config.osu_username }).catch(e => { command_data.global_context.logger.api_error(e); });
