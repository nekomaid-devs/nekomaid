module.exports = {
    ...
    async execute(command_data) {
        ...
        let recent = await command_data.global_context.modules_clients.osu.getUserRecent({ u: command_data.tagged_user_config.osuUsername }).catch(e => { command_data.global_context.logger.api_error(e); });
        ...
        let embedOsu = {
            color: 8388736,
            author: {
                name: `osu! recent plays for ${command_data.tagged_user_config.osuUsername}`,
