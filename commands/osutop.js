module.exports = {
    ...
    async execute(command_data) {
        ...
        let top = await command_data.global_context.modules_clients.osu.getUserBest({ u: command_data.author_config.osuUsername }).catch(e => { command_data.global_context.logger.api_error(e); });
        ...
        let embedOsu = {
            color: 8388736,
            author: {
                name: `osu! top plays for ${command_data.author_config.osuUsername}`,
