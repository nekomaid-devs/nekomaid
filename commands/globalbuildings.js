module.exports = {
    ...
    async execute(command_data) {
        ...
        buildings_description += `\`[Neko's Mayor House]      [${"=".repeat(command_data.global_context.bot_config.b_mayor_house)}>${" ".repeat(10 - command_data.global_context.bot_config.b_mayor_house)}] Level ${command_data.global_context.bot_config.b_mayor_house} (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.global_context.bot_config.b_mayor_house, "b_mayor_house"))} $)\`\n`;
        ...
        buildings_description += `\`[Neko's Community Center] [${"=".repeat(command_data.global_context.bot_config.b_community_center)}>${" ".repeat(10 - command_data.global_context.bot_config.b_community_center)}] Level ${command_data.global_context.bot_config.b_community_center} (${command_data.global_context.utils.format_number(command_data.global_context.neko_modules.vars.get_building_price(command_data.global_context.bot_config.b_community_center, "b_community_center"))} $)\`\n`;
