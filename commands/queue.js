module.exports = {
    ...
    async execute(command_data) {
            ...
            case 0: {
                ...
                for(let i = 1; i <= 5; i += 1) {
                    if(voice_data.queue.length >= i) {
                        ...
                        let user = await command_data.global_context.bot.users.fetch(voice_request.request_user_ID).catch(e => { command_data.global_context.logger.api_error(e); });
            ...
            case 1: {
                ...
                for(let i2 = start; i2 <= start + end; i2++) {
                    if(voice_data.persistent_queue.length > i2) {
                        ...
                        let user2 = await command_data.global_context.bot.users.fetch(voice_request_2.request_user_ID).catch(e => { command_data.global_context.logger.api_error(e); });
        ...
        command_data.msg.channel.send("", { embed: embedQueue }).catch(e => { command_data.global_context.logger.api_error(e); });
    },
};