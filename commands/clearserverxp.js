...
module.exports = {
    ...
    async execute(command_data) {
        ...
        let server_user_configs = await command_data.global_context.neko_modules_clients.ssm.server_fetch.fetch(command_data.global_context, { type: "serverUsers", id: command_data.msg.guild.id })
