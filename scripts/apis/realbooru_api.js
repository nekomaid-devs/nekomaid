class RealbooruAPI {
    async realbooru_result(global_context, args) {
        let site_url_main = `https://realbooru.com/index.php?page=post&s=list${(args.length > 0 ? "&tags=" + args.join("+") : "")}`;
        ...
        while(current_tries <= num_of_tries) {
            ...
            let site_url_posts = `https://realbooru.com/index.php${page}`;
